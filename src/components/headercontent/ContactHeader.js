    ...
    <header className="page-header-content header- d-flex align-items-center justify-content-center text-center" style={{ height: '100vh' }}>
      <div className="container">
        <div className="col-md-12 mx-auto">
          ...
          {/* Main Heading */}
          <h1 className="display-4 text-orange fw-bold">Our Contact</h1>
          <p className="lead text-white fw-bold">We are actively at your services</p>
          <p className="lead text-white fw-bold">You can contact us with all the below means.</p>
        </div>
      </div>
    </header>
  );
